...
This directory contains the open source hardware files for the Cleveland Music Co. Hothouse DSP Pedal Kit. Included are the required gerber, BOM, and CPL files required to fabricate the PCBs at JLCPCB. Also included are suggestions for the various through-hole components and other hardware required.
